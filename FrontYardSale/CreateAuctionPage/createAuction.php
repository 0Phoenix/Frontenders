  ...
  <form action="createAuction.php" method="post" role="form">
   <!-- Auction Title -->
    ...
    <div class="input-group mb-3">
      ...
      <input type="text" class="form-control" aria-describedby="basic-addon3" name="productName" required>
    </div>
    ...
    <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text">Date (YYYY-MM-DD)</span>
        </div>
        <input type="text" aria-label="Date" class="form-control" name="biddate" required>
        <div class="input-group-prepend">
          <span class="input-group-text">Time (HH:MM:SS)</span>
        </div>
